...
const Core:React.FC<CoreProps> = ({id}) => {
    ...
    return <>
        <div id={id} className='h-screen w-screen flex-col '>
            ...
            <div ref={ref1} className='w-screen h-1/2 flex items-center sm:space-x-52 space-x-5'>
                <Image className={`w-28 ml-3 sm:ml-60 sm:w-52 transition-opacity duration-700 delay-75 ease-in-out ${isVisible ? "opacity-100" : "opacity-0"} `} src="/harisha.png" alt="Harisha" width={200} height={200} />
            ...
            <div className='w-screen h-1/2 flex items-start sm:items-center space-x-5 sm:space-x-52'>
                <Image className={`w-28 ml-3 sm:ml-60 sm:w-52 transition-opacity duration-1000 delay-700 ease-in-out ${isVisible ? "opacity-100" : "opacity-0"} `} src="/nihar.png" alt="Nihar" width={200} height={200} />
                <Image className={`w-28 sm:ml-60 sm:w-52 transition-opacity duration-700 delay-1000 ease-in-out ${isVisible ? "opacity-100" : "opacity-0"} `} src="/harshil.png" alt="Harshil" width={200} height={200} />
                <Image className={`w-28 sm:ml-60 sm:w-52 transition-opacity duration-700 delay-1200 ease-in-out ${isVisible ? "opacity-100" : "opacity-0"} `} src="/kulkarni.png" alt="Kulkarni" width={200} height={200} />
