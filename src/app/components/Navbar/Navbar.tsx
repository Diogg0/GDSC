...
const navbar:React.FC<navbarProps> = () => {
    ...
    return <>
        ...
        <nav className="h-20 w-full flex items-center justify-between pr-8 drop-shadow-2xl sticky z-50 bg-white border-black">
        <Image className="left-0 ml-5 py-5" src="/long-logo.png" alt='logo' width={250} height={250}></Image>
            <div className="flex items-center space-x-14 pr-10 py-3 text-xl font-normal">
