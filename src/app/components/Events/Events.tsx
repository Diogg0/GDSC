...
const Events:React.FC<EventsProps> = ({id}) => {
    ...
    const events = [{name:"Dino Dash", desc:"Participants take on the challenge of the classic Google dino game brought to life using AI technology. Cameras track their movements, projecting obstacles onto the smartboard in real-time. With each obstacle, participants must physically jump or duck to evade, competing to tackle the most hurdles for victory.", "link":"https://forms.gle/hT6Awgp5kpGPJae88"}, {"name":"Prompt Artistry", "desc":"Your mission is to reverse engineer these images, crafting prompts that yield similar results. Teams compete to generate images closest to the provided set, with the accuracy of their creations assessed through advanced differential hashing algorithms, blending creativity with technical prowess in an exciting artistic challenge.", "link":"https://forms.gle/JfR6yUtmLLG1LgbS7"}, {"name":"Cosmic Relay", "desc":"Teams of four navigate through a series of commands appearing on their individual consoles, utilizing a variety of buttons with unique functionalities. As tasks escalate, communication among teammates becomes crucial to overcome challenges within the given time frame, leading to an exhilarating experience filled with chaos and camaraderie.", "link":"https://forms.gle/WbG4T1YSdYVFmVFb8"}, {"name":"Schrödinger's Hunt", "desc":"Teams of 3 to 4 embark on a two-round challenge, beginning with physics simulations and transitioning to debugging code to reveal hidden images. Assembled images form a larger picture of a location within RAIT, where teams must locate and explore boxes embodying Schrödinger's superposition paradox—its contents remain a mystery until opened.", "link":"https://forms.gle/ExjjNBYASF2dBGfD7"}];
