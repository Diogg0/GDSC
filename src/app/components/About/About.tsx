    ...
    return <>
      <meta name="viewport" content="width=device-width, initial-scale=1 height=device-height" />
        <div ref={ref1} className="w-full h-60 sm:w-screen sm:h-screen">
            ...
            <div className="flex w-3/4 h-3/5 -translate-x-10 -translate-y-10 sm:h-1/4 md:w-1/2 md:h-full bg-gblue rounded-full sm:-translate-y-40 sm:-translate-x-40 items-start text-center" >
